...
def process_dataset():
    ...
    for csv_path in csv_files:
        ...
        print(f"Extracting raw segments from folder '{folder_name}'...")
        ...
        for wav_path in tqdm(wav_files):
            ...
            if not drone_intervals:
                ...
                # חילוץ גושי הרקע המלאים שבין הרחפנים
    ...
    print(f"\n--- Stage 1 Finished! Full raw segments saved to {OUTPUT_DIR} ---")
